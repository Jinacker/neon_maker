              ...
              <>
                <div className="product-info-section">
                  ...
                  <div className="info-grid">
                    ...
                    <div className="info-item">
                      ...
                      <span className="info-value">예 (현장 판매 물량 모두 소진하고, 추가 구매 원할시 통신판매 진행 예정)</span>
                    </div>
                  </div>
                </div>
                ...
                <div className="problem-section">
                  ...
                  <div className="problem-item">
                    ...
                    <p>탁상시계를 구입했다 - 오래 사용하니 시간이 틀어짐(오차 발생)<br/>
                ...
                <div className="manual-section">
                  ...
                  <div className="step-section">
                    ...
                    <ul>
                      <li><strong>3-1.</strong> 만약, 디스플레이가 에러 화면으로 나타난다면, wifi의 비밀번호가 틀렸을 가능성이 있습니다. (연결실패), 이 경우 2번 섹션으로 돌아가 다시 wifi 정보를 입력해 줍니다.</li>
                      <li><strong>3-2.</strong> 디스플레이의 변화가 없다면, 이는 wifi 연결 과정에서 문제가 생긴 것입니다. (인증 관련 문제) 따라서 이 경우 2번 섹션으로 돌아가 다시 wifi 정보를 입력해 줍니다.</li>
                      <li><strong>3-3.</strong> 위 문제에 해당하지 않는다면 다음 섹션으로 이동하십시오.</li>
                    </ul>
                  </div>
                  ...
                  <div className="step-section">
                    ...
                    <p><strong>오프라인 상태인 경우:</strong><br/>
                    wifi 연결이 불량하여 오프라인 상태인 경우, 디스플레이 하단에 "! RTC mode" 라 표기되며<br/>
                    오프라인 상태에서 최대 30일동안 사용할 수 있습니다.</p>
                    
                    <p><strong>30일 초과한 경우:</strong><br/>
                    시계는 강제 재부팅을 하게 되며, 재부팅 이후에 wifi 연결에 실패할 경우,<br/>
                    2번 섹션으로 돌아가 wifi 설정을 완료하여 주십시오.</p>
                  </div>
                </div>
              </>
            ) : (
