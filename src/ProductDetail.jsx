                  ...
                  <div className='step-section'>
                    ...
                    <ImageSlider images={["/task6/step1.png", "/task6/step2.png", "/task6/step3.png", "/task6/step4.png", "/task6/step5.png",
                      "/task6/step6.png", "/task6/step7.png", "/task6/step8.jpg", "/task6/step9.png"]} texts={[
                        <>1. 체험자는 메이커로부터 [덮개 부품, 무선충전모듈, 베이스 부품]을 전달받습니다.</>,
                        <>2. 체험자는 전달받은 무선충전모듈을 충전 단자 방향에 유의하여 베이스 모델 안에 위치합니다.<br />
                          → 이때, 좌/우로 흔들림을 미연에 방지하기 위해, 글루건을 사용하여 무선충전모듈을 고정합니다.</>,
                        <>2. 체험자는 전달받은 무선충전모듈을 충전 단자 방향에 유의하여 베이스 모델 안에 위치합니다.<br />
                          → 이때, 좌/우로 흔들림을 미연에 방지하기 위해, 글루건을 사용하여 무선충전모듈을 고정합니다.</>,
                        <>3. 체험자는 덮개 부품을 고르고, 덮개 부품을 베이스 부품과 결합 합니다.</>,
                        <>3. 체험자는 덮개 부품을 고르고, 덮개 부품을 베이스 부품과 결합 합니다.</>,
              ...
              <>
                ...
                <div className="features-section">
                  <div className='step-section'>
                    <h2>제품 설명</h2>
                    <ul>
                      <li><a href="https://blog.naver.com/manje8954/220833614843">SKY IM-100 스마트폰과 함께 제공되었던 '스톤(Stone)' 블루투스 스피커의 스피커</a> 유닛을 활용하여 제작한 휴대용 블루투스 스피커</li>
